...
import { getPostData, formatPostData } from "../../common/helper";
...
const Post = ({ state, actions, libraries }) => {
    ...
    useEffect(() => {
        Object.values(beforeSSRCategories).map(category => actions.source.fetch(`/category/${category.name}/`));
    }, []);
    ...
    return (
        ...
        //     {post.featured_media != null && <FeaturedMedia id={post.featured_media.id} />}

        //     {/* Render the content using the Html2React component so the HTML is processed
        //    by the processors we included in the libraries.html2react.processors array. */}
        //     <Content as={Section} px={{ base: "32px", md: "0" }} size="md" pt="50px">
